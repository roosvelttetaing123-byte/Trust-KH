...
for i in range(6):
    ...
    result=analyze('message',f'Synthetic demonstration. Send your OTP at https://domain-placeholder.test and contact @helpdesk_demo.'.replace('domain-placeholder.test',domain),s.hmac_key)
    receipt=store.report(result,{'scan_id':uuid.uuid4().hex,'consent_version':'2026-09-09.v1','category':'investment','channel':'telegram'})
