...
COPY = {
    ...
    'km': {
        ...
        'reasons': 'មូលហេតុនៃលទ្ធផលនេះ', 'none': 'មិនរកឃើញសញ្ញាព្រមានតាមច្បាប់មូលដ្ឋានទេ។ នេះមិនបញ្ជាក់ថាមានសុវត្ថិភាពឡើយ។',
        ...
        'limits': 'ប្រើតែច្បាប់មូលដ្ឋាន។ មិនមានទិន្នន័យគំរាមកំហែងផ្ទាល់ មិនពិនិត្យធនាគារ មិនបើកគេហទំព័រ និងមិនផ្ទៀងផ្ទាត់អត្តសញ្ញាណអ្នកទទួលប្រាក់ទេ។',
        ...
        'demo': 'ទិន្នន័យសាកល្បង — មិនមែនជាការគំរាមកំហែងពិតទេ', 'version': 'កំណែច្បាប់ពិនិត្យ', 'page': 'ទំព័រ'
    },
    'zh': {
